  ...
  useEffect(() => {
    ...
    var positions = [
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.55376, 126.969662),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.532709, 126.99),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.541169, 126.96765),
      },
      {
        title: "서울특별시 용산구 원효지구대 방범순찰대(옛 용산구청)",
        latlng: new kakao.maps.LatLng(37.538716, 126.96589),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.523302, 126.96868),
      },
      {
        title: "서울특별시 용산구 국방부 컨벤스 1층 외부",
        latlng: new kakao.maps.LatLng(37.533237, 126.97859),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.533417, 126.96736),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.52911, 126.968532),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.533918, 126.95763),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.53461, 126.966177),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.55492, 126.968415),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.551185, 126.96922),
      },
      {
        title: "서울특별시 용산구 애전빌딩 옥상",
        latlng: new kakao.maps.LatLng(37.54175, 126.970388),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.54154, 126.971791),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.54096, 126.973516),
      },
      {
      ...
      },
      {
        ...
        latlng: new kakao.maps.LatLng(37.5485, 126.977574),
      },
      {
        title: "서울특별시 용산구 한치과의원 건물 주차장",
        latlng: new kakao.maps.LatLng(37.54589, 126.976959),
      },
      {
      ...
      {
        title: "서울특별시 용산구 한국폴리텍대학 정수캠퍼스",
        latlng: new kakao.maps.LatLng(37.52871, 126.996226),
      },
      {
        title: "서울특별시 용산구 한국폴리텍대학 정수캠퍼스",
